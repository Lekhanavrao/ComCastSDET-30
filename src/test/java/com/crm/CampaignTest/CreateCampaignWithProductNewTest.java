...
public class CreateCampaignWithProductNewTest {
	@Test
	public void createCampaignWithProduct() throws Throwable
	{
		...
		String campaignName = eLib.readDataFromExcelSheet("Campaigns", 1, 2)+"_"+jLib.getRandomNuumber();
		String prodName = eLib.readDataFromExcelSheet("Campaigns", 1, 3);
		String catType = eLib.readDataFromExcelSheet("Campaigns", 1, 4);
